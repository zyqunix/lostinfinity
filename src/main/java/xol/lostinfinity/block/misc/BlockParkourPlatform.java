...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/block/misc/BlockParkourPlatform.class */
public class BlockParkourPlatform extends BlockBasic {
    ...
    public AxisAlignedBB func_180646_a(IBlockState blockState, IBlockAccess worldIn, BlockPos pos) {
        if (blockState.equals(func_176203_a(2))) {
