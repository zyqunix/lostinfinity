...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/block/misc/BlockViralGrowth.class */
public class BlockViralGrowth extends BlockBasicGlass {
        ...
        if (!worldIn.field_72995_K && (entityIn instanceof EntityPlayer)) {
            ...
            if (!player.func_184812_l_() && player.field_70173_aa % 5 == 0 && player.func_110143_aJ() > 0.0f) {
                ...
                if (player.func_110143_aJ() <= 0.0f) {
                    DeathMessage.broadcastDeathMessage(player.func_184102_h(), TextFmt.Red + player.func_70005_c_() + " died to a virus.");
                }
            }
        }
    }
