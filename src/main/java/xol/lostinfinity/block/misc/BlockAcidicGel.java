...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/block/misc/BlockAcidicGel.class */
public class BlockAcidicGel extends Block implements IMaxAttack {
    ...
    public BlockAcidicGel(String name, float hardness, Material material, CreativeTabs tab) {
        super(material);
        func_149663_c(name);
    ...
    public void func_180634_a(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
        if (!worldIn.field_72995_K && (entityIn instanceof EntityPlayer) && entityIn.field_70173_aa % 4 == 2) {
