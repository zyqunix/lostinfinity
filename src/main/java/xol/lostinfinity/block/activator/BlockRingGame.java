...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/block/activator/BlockRingGame.class */
public class BlockRingGame extends BlockBasic {
    ...
    */
    private void reset(net.minecraft.world.World r12, net.minecraft.util.math.BlockPos r13, net.minecraft.block.state.IBlockState r14, net.minecraft.entity.player.EntityPlayer r15, net.minecraft.util.EnumHand r16, net.minecraft.util.EnumFacing r17, float r18, float r19, float r20) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: xol.lostinfinity.block.activator.BlockRingGame.reset(net.minecraft.world.World, net.minecraft.util.math.BlockPos, net.minecraft.block.state.IBlockState, net.minecraft.entity.player.EntityPlayer, net.minecraft.util.EnumHand, net.minecraft.util.EnumFacing, float, float, float):void");
    }
    ...
    private static Vec3i findTileDir(World worldIn, BlockPos pos) {
        ...
        dirs.add(new Vec3i(1, 0, -1));
        for (Vec3i dir : dirs) {
            if (worldIn.func_180495_p(pos.func_177971_a(dir)).func_177230_c().equals(BlockInit.ringTile)) {
                return dir;
            }
        }
        return null;
