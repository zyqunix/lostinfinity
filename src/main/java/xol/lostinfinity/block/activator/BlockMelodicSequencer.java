...
public class BlockMelodicSequencer extends BlockBasic implements ITileEntityProvider {
    ...
    public boolean func_180639_a(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if (tileEntity != null && (tileEntity instanceof TileEntityMelodicSequencer) && stack.func_77973_b() == ItemInit.blankOpticalDisc) {
            TileEntityMelodicSequencer deviceEntity = (TileEntityMelodicSequencer) tileEntity;
            if (!worldIn.field_72995_K) {
                playerIn.func_145747_a(new TextComponentString("Repeat the sequences!"));
