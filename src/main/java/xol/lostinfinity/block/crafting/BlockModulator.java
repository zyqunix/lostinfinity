...
public class BlockModulator extends BlockBasicGui {
    ...
    public boolean func_180639_a(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        if (!playerIn.func_70093_af()) {
            ...
            if (poweredCount == 4) {
                playerIn.openGui(lostinfinity.instance, GuiHandler.RegisteredGuis.MODULATOR.getId(), worldIn, pos.func_177958_n(), pos.func_177956_o(), pos.func_177952_p());
                return true;
            }
            if (!worldIn.field_72995_K) {
                playerIn.func_145747_a(new TextComponentString(TextFmt.Red + "The modulator is unpowered."));
                return true;
            }
            return true;
        }
