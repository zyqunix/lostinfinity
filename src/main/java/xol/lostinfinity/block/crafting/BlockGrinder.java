...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/block/crafting/BlockGrinder.class */
public class BlockGrinder extends BlockBasicGui implements ITileEntityProvider {
    ...
    public BlockGrinder(String name, Material material, CreativeTabs tab, boolean isBurning) {
    ...
    public Item func_180660_a(IBlockState state, Random rand, int fortune) {
        return Item.func_150898_a(BlockInit.grinder);
    }
    ...
    private TileEntityGrinder getTE(World world, BlockPos pos) {
        return (TileEntityGrinder) world.func_175625_s(pos);
    }

    @Override // xol.lostinfinity.block.basic.BlockBasicGui
    public boolean func_180639_a(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        if (!playerIn.func_70093_af()) {
            playerIn.openGui(lostinfinity.instance, GuiHandler.RegisteredGuis.GRINDER.getId(), worldIn, pos.func_177958_n(), pos.func_177956_o(), pos.func_177952_p());
            return true;
        }
        return true;
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos) {
        ...
        if (active) {
            worldIn.func_180501_a(pos, BlockInit.grinder.func_176223_P().func_177226_a(BURNING, true), 3);
        } else {
            worldIn.func_180501_a(pos, BlockInit.grinder.func_176223_P().func_177226_a(BURNING, false), 3);
        }
        if (tileentity != null) {
    ...
    public void func_180663_b(World worldIn, BlockPos pos, IBlockState state) {
        TileEntityGrinder tileentity = (TileEntityGrinder) worldIn.func_175625_s(pos);
    ...
    public void func_190948_a(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add(TextFmt.Italic + "High strength industrial grinder.");
    }
}
