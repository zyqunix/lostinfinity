...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/gui/containers/ContainerRainfallGenerator.class */
public class ContainerRainfallGenerator extends Container {
    private final TileEntityRainfallGenerator tileentity;
    private int burnTime;
    private int currentBurnTime;

    public ContainerRainfallGenerator(InventoryPlayer player, TileEntityRainfallGenerator tileEntityRainfallGenerator) {
        this.tileentity = tileEntityRainfallGenerator;
        func_75146_a(new Slot(tileEntityRainfallGenerator, 0, 80, 28) { // from class: xol.lostinfinity.gui.containers.ContainerRainfallGenerator.1
            public boolean func_75214_a(ItemStack stack) {
                return TileEntityRainfallGenerator.isItemFuel(stack);
            }
