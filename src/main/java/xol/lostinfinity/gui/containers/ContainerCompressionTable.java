...
public class ContainerCompressionTable extends Container {
    ...
    static  class AnonymousClass3 {
        static final  int[] $SwitchMap$xol$lostinfinity$gui$containers$ContainerCompressionTable$CompressionTableStatus = new int[CompressionTableStatus.values().length];
        static {
            try {
