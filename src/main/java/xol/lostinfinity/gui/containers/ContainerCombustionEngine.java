...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/gui/containers/ContainerCombustionEngine.class */
public class ContainerCombustionEngine extends Container {
    private final TileEntityCombustionEngine tileentity;
    private int burnTime;
    private int currentBurnTime;

    public ContainerCombustionEngine(InventoryPlayer player, TileEntityCombustionEngine tileEntityCombustionEngine) {
        this.tileentity = tileEntityCombustionEngine;
        func_75146_a(new Slot(tileEntityCombustionEngine, 0, 80, 28) { // from class: xol.lostinfinity.gui.containers.ContainerCombustionEngine.1
            public boolean func_75214_a(ItemStack stack) {
                return TileEntityCombustionEngine.isItemFuel(stack);
            }
    ...
    public ItemStack func_82846_b(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.func_75216_d()) {
            ...
            if (index == 2) {
                ...
                if (TileEntityCombustionEngine.isItemFuel(itemstack1)) {
