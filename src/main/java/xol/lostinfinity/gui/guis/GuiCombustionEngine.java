...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/gui/guis/GuiCombustionEngine.class */
public class GuiCombustionEngine extends GuiContainer {
    public static final int WIDTH = 175;
    public static final int HEIGHT = 165;
    private static final ResourceLocation background = new ResourceLocation(Reference.MODID, "textures/gui/combustion_engine.png");
    private final InventoryPlayer player;
    private final TileEntityCombustionEngine tileentity;

    public GuiCombustionEngine(InventoryPlayer player, TileEntityCombustionEngine tileEntityCombustionEngine) {
        super(new ContainerCombustionEngine(player, tileEntityCombustionEngine));
        this.player = player;
