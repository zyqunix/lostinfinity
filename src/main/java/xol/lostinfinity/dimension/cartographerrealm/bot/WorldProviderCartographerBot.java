...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/dimension/cartographerrealm/bot/WorldProviderCartographerBot.class */
public class WorldProviderCartographerBot extends WorldProvider {
    ...
    public IChunkGenerator func_186060_c() {
        return new ChunkGeneratorCartographerBot(this.field_76579_a, this.field_76579_a.func_72905_C() + ((long) getDimension()));
    }
