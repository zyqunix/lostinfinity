...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/common/packets/serverbound/PacketSupplyInventoryServer.class */
public class PacketSupplyInventoryServer implements IMessage {
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/common/packets/serverbound/PacketSupplyInventoryServer$SupplyInventoryServerPacketHandler.class */
