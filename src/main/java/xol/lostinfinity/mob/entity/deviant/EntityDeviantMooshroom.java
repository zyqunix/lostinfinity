...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/mob/entity/deviant/EntityDeviantMooshroom.class */
public class EntityDeviantMooshroom extends EntityDeviantMob implements IMaxAttack {
    public EntityDeviantMooshroom(World worldIn) {
        super(worldIn);
        func_70105_a(4.0f, 3.25f);
    }
