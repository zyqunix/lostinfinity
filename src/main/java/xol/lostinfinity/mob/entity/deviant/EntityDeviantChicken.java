...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/mob/entity/deviant/EntityDeviantChicken.class */
public class EntityDeviantChicken extends EntityDeviantMob implements IMaxAttack {
    public EntityDeviantChicken(World worldIn) {
        super(worldIn);
        func_70105_a(1.6f, 2.0f);
    }
