...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/mob/entity/deviant/EntityDeviantCaveSpider.class */
public class EntityDeviantCaveSpider extends EntityDeviantMob {
    public EntityDeviantCaveSpider(World worldIn) {
        super(worldIn);
