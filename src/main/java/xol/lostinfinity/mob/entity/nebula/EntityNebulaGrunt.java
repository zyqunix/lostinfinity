...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/mob/entity/nebula/EntityNebulaGrunt.class */
public class EntityNebulaGrunt extends EntityFloatingBase implements IMaxAttack {
    private float modelAlpha;
    private static final DataParameter<Optional<BlockPos>> HOME_POS = EntityDataManager.func_187226_a(EntityNebulaGrunt.class, DataSerializers.field_187201_k);

    public EntityNebulaGrunt(World worldIn) {
        super(worldIn);
        this.modelAlpha = 0.0f;
        func_70105_a(2.1f, 2.5f);
        this.field_70765_h = new AIMoveControl(this);
        this.field_70145_X = true;
    }

    public EntityNebulaGrunt(World worldIn, BlockPos parentBlock) {
        super(worldIn);
        this.modelAlpha = 0.0f;
        func_70105_a(2.1f, 2.5f);
    ...
    public void func_70636_d() {
        ...
        if (func_70638_az() != null && func_70032_d(func_70638_az()) <= 3.0f) {
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/mob/entity/nebula/EntityNebulaGrunt$AIMoveControl.class */
