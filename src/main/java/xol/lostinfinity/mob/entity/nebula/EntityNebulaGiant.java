...
public class EntityNebulaGiant extends EntityFloatingBase implements IMaxAttack {
    ...
    public void func_70636_d() {
        ...
        if (this.field_70173_aa % 100 == 0) {
            this.field_70170_p.func_184133_a((EntityPlayer) null, func_180425_c(), SoundInit.NEBULA_GIANT_SHOCKWAVE, SoundCategory.HOSTILE, 1.5f, 0.8f + (this.field_70146_Z.nextFloat() * 0.4f));
            ...
            List<EntityPlayer> list = this.field_70170_p.func_72872_a(EntityPlayer.class, func_174813_aQ().func_186662_g(EXPLOSION_RANGE));
