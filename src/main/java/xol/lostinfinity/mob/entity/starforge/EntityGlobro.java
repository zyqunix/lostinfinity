...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/mob/entity/starforge/EntityGlobro.class */
public class EntityGlobro extends EntityMob implements IMaxAttack, IBasicAI {
    public EntityGlobro(World worldIn) {
        super(worldIn);
