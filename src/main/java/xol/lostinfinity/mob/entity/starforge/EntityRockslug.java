...
public class EntityRockslug extends EntityMob implements IMaxAttack, IBasicAI {
    ...
    public void func_70636_d() {
        ...
        if (!this.field_70170_p.field_72995_K) {
            ...
            if (this.field_70173_aa % 200 == 0 && this.feedLevel > 0) {
    ...
    public boolean func_184645_a(EntityPlayer player, EnumHand hand) {
        ...
        if (itemstack.func_77973_b() == ItemInit.rockfeed) {
            if (!this.field_70170_p.field_72995_K) {
                this.feedLevel++;
                player.func_145747_a(new TextComponentString(TextFmt.Aqua + "The rockslug gulps down the pebbles. It has " + this.feedLevel + " shots remaining."));
            }
