...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/mob/entity/starforge/EntityHypnosaur.class */
public class EntityHypnosaur extends EntityMob implements IMaxAttack, IBasicAI {
    ...
    public EntityHypnosaur(World worldIn) {
        super(worldIn);
    ...
    public void func_70636_d() {
        ...
        if (func_70638_az() != null) {
            ...
            if (this.field_70173_aa % 20 == 0) {
                func_70638_az().func_145747_a(new TextComponentString(TextFmt.Dark_Purple + "You feel unable to move."));
            }
        }
    }
