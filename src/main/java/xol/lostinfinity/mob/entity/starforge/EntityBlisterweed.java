    ...
    public void func_70636_d() {
        ...
        if (this.field_70173_aa % 4 == 0 && !this.field_70170_p.field_72995_K) {
            ...
            if (playerNearby) {
                ...
                shot.func_70186_c(((-0.5f) + this.field_70146_Z.nextFloat()) * 0.5f, -0.20000000298023224d, ((-0.5f) + this.field_70146_Z.nextFloat()) * 0.5f, 1.0f, 0.0f);
                this.field_70170_p.func_72838_d(shot);
                func_184185_a(SoundInit.BLISTERWEED_ATTACK, 2.0f, 0.8f + (this.field_70146_Z.nextFloat() * 0.4f));
            }
        }
    }
