...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/mob/entity/starforge/EntityFlapper.class */
public class EntityFlapper extends EntityFloatingBase implements IMaxAttack {
    public EntityFlapper(World worldIn) {
        super(worldIn);
