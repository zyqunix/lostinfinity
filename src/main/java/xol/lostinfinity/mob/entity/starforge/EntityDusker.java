...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/mob/entity/starforge/EntityDusker.class */
public class EntityDusker extends EntityMob implements IMaxAttack, IBasicAI {
    public EntityDusker(World worldIn) {
        super(worldIn);
