...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/mob/entity/starforge/EntityFyreweed.class */
public class EntityFyreweed extends EntityMob implements IMaxAttack {
    public EntityFyreweed(World worldIn) {
        super(worldIn);
        func_70105_a(0.75f, 1.7f);
    }
        ...
        if (this.field_70173_aa % 45 == 0) {
            ...
            for (EntityPlayer near_pl : this.field_70170_p.func_72872_a(EntityPlayer.class, func_174813_aQ().func_72314_b(25.0d, 25.0d, 25.0d))) {
                if (!near_pl.func_184812_l_() && !this.field_70170_p.field_72995_K) {
                    ...
                    double makeY = (this.field_70163_u + ((double) (this.field_70131_O / 2.0f))) - 0.75d;
