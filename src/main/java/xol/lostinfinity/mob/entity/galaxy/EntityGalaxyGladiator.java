...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/mob/entity/galaxy/EntityGalaxyGladiator.class */
public class EntityGalaxyGladiator extends EntityMob implements IMaxAttack, IBasicAI {
    private static final DataParameter<Byte> COLOR = EntityDataManager.func_187226_a(EntityGalaxyGladiator.class, DataSerializers.field_187191_a);

    public EntityGalaxyGladiator(World worldIn) {
        super(worldIn);
    ...
    public void func_70636_d() {
        ...
        if (func_70638_az() != null && !this.field_70170_p.field_72995_K && this.field_70173_aa % 60 == 0) {
            ...
            func_184185_a(SoundInit.ARENA_TELEPORT, 2.0f, 1.0f);
        }
    }
