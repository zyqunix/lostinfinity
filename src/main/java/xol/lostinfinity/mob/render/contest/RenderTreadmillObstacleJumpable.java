...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/mob/render/contest/RenderTreadmillObstacleJumpable.class */
public class RenderTreadmillObstacleJumpable extends RenderLiving<EntityTreadmillObstacle> {
    ...
    public RenderTreadmillObstacleJumpable(RenderManager manager) {
        super(manager, new ModelTreadmillObstacleJumpable(), 1.0f);
    }
