...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/mob/render/contest/RenderContraderLaserTag.class */
public class RenderContraderLaserTag extends RenderLiving<EntityContraderLaserTag> {
    ...
    public void func_77043_a(EntityContraderLaserTag entityLiving, float p1, float rotationYaw, float partialTicks) {
        super.func_77043_a(entityLiving, p1, rotationYaw, partialTicks);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    /* JADX INFO: renamed from: getEntityTexture, reason: merged with bridge method [inline-methods] */
    public ResourceLocation func_110775_a(EntityContraderLaserTag entity) {
        return TEXTURES;
    }
}
