...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/mob/render/deviant/RenderDeviantSlimeStrider.class */
public class RenderDeviantSlimeStrider extends RenderLiving<EntityDeviantSlimeStrider> {
    ...
    public RenderDeviantSlimeStrider(RenderManager manager) {
        super(manager, new ModelDeviantSlimeStrider(), 0.5f);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    /* JADX INFO: renamed from: preRenderCallback, reason: merged with bridge method [inline-methods] */
    public void func_77041_b(EntityDeviantSlimeStrider entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a(1.5f, 1.5f, 1.5f);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    /* JADX INFO: renamed from: getEntityTexture, reason: merged with bridge method [inline-methods] */
    public ResourceLocation func_110775_a(EntityDeviantSlimeStrider entity) {
    ...
    public void func_77043_a(EntityDeviantSlimeStrider entityLiving, float p1, float rotationYaw, float partialTicks) {
