...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/mob/render/deviant/RenderDeviantGhast.class */
public class RenderDeviantGhast extends RenderLiving<EntityDeviantGhast> {
    ...
    public RenderDeviantGhast(RenderManager manager) {
        super(manager, new ModelDeviantGhast(), 0.5f);
        this.scale = 3.0f;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    /* JADX INFO: renamed from: preRenderCallback, reason: merged with bridge method [inline-methods] */
    public void func_77041_b(EntityDeviantGhast entitylivingbaseIn, float partialTickTime) {
        GlStateManager.func_179152_a(this.scale, this.scale, this.scale);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    /* JADX INFO: renamed from: getEntityTexture, reason: merged with bridge method [inline-methods] */
    public ResourceLocation func_110775_a(EntityDeviantGhast entity) {
    ...
    public void func_77043_a(EntityDeviantGhast entityLiving, float p1, float rotationYaw, float partialTicks) {
