...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/mob/model/galaxy/ModelGalaxySorcerer.class */
public class ModelGalaxySorcerer extends ModelBase {
    ...
    public ModelGalaxySorcerer() {
        ...
        this.body2 = new ModelRenderer(this, 34, 46);
        ...
        setRotateAngle(this.armr, -1.2217305f, 0.0f, 0.0f);
