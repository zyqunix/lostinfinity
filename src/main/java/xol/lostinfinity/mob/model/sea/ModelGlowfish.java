...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/mob/model/sea/ModelGlowfish.class */
public class ModelGlowfish extends ModelBase {
    ...
    public ModelGlowfish() {
        ...
        this.BodyEnd2 = new ModelRenderer(this);
        ...
        this.TailfinLeft2 = new ModelRenderer(this);
        ...
        this.TailfinRight2 = new ModelRenderer(this);
    ...
    public void func_78087_a(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        this.BodyEnd.field_78796_g = MathHelper.func_76134_b(ageInTicks * 0.15f) * 0.5f;
        this.BodyEnd2.field_78796_g = MathHelper.func_76134_b(ageInTicks * 0.15f) * 0.5f;
        this.BodyMiddle.field_78796_g = (-MathHelper.func_76126_a(ageInTicks * 0.15f)) * 0.5f;
        this.FinLeft.field_78808_h = MathHelper.func_76126_a((ageInTicks + 4) * 0.15f) * 0.4f;
        this.FinRight.field_78808_h = (-MathHelper.func_76126_a((ageInTicks + 4) * 0.15f)) * 0.4f;
        this.TailfinLeft.field_78808_h = MathHelper.func_76126_a(ageInTicks * 0.65f) * 0.3f;
        this.TailfinRight.field_78808_h = (-MathHelper.func_76126_a(ageInTicks * 0.65f)) * 0.3f;
        this.TailfinLeft2.field_78808_h = MathHelper.func_76134_b(ageInTicks * 0.65f) * 0.3f;
        this.TailfinRight2.field_78808_h = (-MathHelper.func_76134_b(ageInTicks * 0.65f)) * 0.3f;
    }
}
