...
public class ModelLeviathan extends ModelBase {
    ...
    public ModelLeviathan() {
        ...
        this.FinTop = new ModelRenderer(this);
        ...
        setRotationAngle(this.cube_r3, -2.1817f, 0.0f, 0.0f);
    ...
    public void func_78087_a(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        if (modelRenderer == this.BodyFin) {
            this.FinLeft.field_78796_g = (float) MathHelper.func_151238_b(-0.5235987901687622d, -1.3962633609771729d, LMath.trig01(MathHelper.func_76126_a((ageInTicks / 10.0f) - (segment.getId() / 2.0f))));
            this.FinRight.field_78796_g = -this.FinLeft.field_78796_g;
            return;
        }
        if (modelRenderer == this.Head) {
            switch (AnonymousClass1.$SwitchMap$xol$lostinfinity$mob$entity$sea$leviathan$EntityLeviathanController$Phase[segment.mo307getRelay().getLeviathanPhase().ordinal()]) {
                case 1:
                case 2:
                    if (segment.mo307getRelay().getLeviathanPhaseData() == 1) {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                $SwitchMap$xol$lostinfinity$mob$entity$sea$leviathan$EntityLeviathanController$Phase[EntityLeviathanController.Phase.CHARGE.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$xol$lostinfinity$mob$entity$sea$leviathan$EntityLeviathanController$Phase[EntityLeviathanController.Phase.VOLLEY.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$xol$lostinfinity$mob$entity$sea$leviathan$EntityLeviathanController$Phase[EntityLeviathanController.Phase.TESLA.ordinal()] = 4;
