...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/mob/model/deviant/ModelDeviantCow.class */
public class ModelDeviantCow extends ModelBase {
    ...
    public ModelDeviantCow() {
        ...
        setRotateAngle(this.spine1, 1.5707964f, 0.0f, 0.0f);
        ...
        setRotateAngle(this.spine2, 1.5707964f, 0.0f, 0.0f);
