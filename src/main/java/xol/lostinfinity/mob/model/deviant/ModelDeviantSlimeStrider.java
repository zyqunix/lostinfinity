...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/mob/model/deviant/ModelDeviantSlimeStrider.class */
public class ModelDeviantSlimeStrider extends ModelBase {
    ...
    public ModelDeviantSlimeStrider() {
        ...
        this.arml11 = new ModelRenderer(this, 32, 48);
        ...
        this.arml12 = new ModelRenderer(this, 32, 48);
        ...
        this.body2 = new ModelRenderer(this, 6, 0);
        ...
        this.arml9 = new ModelRenderer(this, 32, 48);
    ...
    public void func_78087_a(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        this.arml9.field_78795_f = MathHelper.func_76134_b(limbSwing * 0.1162f) * 0.9f * limbSwingAmount;
        this.arml10.field_78795_f = MathHelper.func_76134_b(limbSwing * 0.1162f) * 0.9f * limbSwingAmount;
        this.arml11.field_78795_f = MathHelper.func_76134_b(limbSwing * 0.1162f) * 0.9f * limbSwingAmount;
        this.arml12.field_78795_f = MathHelper.func_76134_b(limbSwing * 0.1162f) * 0.9f * limbSwingAmount;
