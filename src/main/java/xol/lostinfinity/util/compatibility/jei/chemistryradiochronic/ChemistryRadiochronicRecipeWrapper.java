...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/util/compatibility/jei/chemistryradiochronic/ChemistryRadiochronicRecipeWrapper.class */
public class ChemistryRadiochronicRecipeWrapper implements IRecipeWrapper {
    ...
    public static List<ChemistryRadiochronicRecipeWrapper> getRecipes(IJeiHelpers helpers) {
        ...
        List<ChemistryRadiochronicRecipeWrapper> jeiRecipes = Lists.newArrayList();
