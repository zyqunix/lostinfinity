...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/util/compatibility/jei/trades/zirconia/crimson/CrimsonTradeCategory.class */
public class CrimsonTradeCategory implements IRecipeCategory {
    ...
    public CrimsonTradeCategory(IGuiHelper guiHelper) {
        ...
        this.icon = guiHelper.createDrawableIngredient(new ItemStack(BlockInit.screenHunterKiller));
    }
