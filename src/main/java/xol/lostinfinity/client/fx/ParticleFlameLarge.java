...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleFlameLarge.class */
public class ParticleFlameLarge extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleFlameLarge(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.growSpeed = 0.4f;
        func_187117_a(ParticleInit.FLAME_LARGE_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleFlameLarge$Factory.class */
