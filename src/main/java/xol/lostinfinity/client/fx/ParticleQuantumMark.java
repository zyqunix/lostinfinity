...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleQuantumMark.class */
public class ParticleQuantumMark extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleQuantumMark(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.QUANTUM_MARK_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleQuantumMark$Factory.class */
