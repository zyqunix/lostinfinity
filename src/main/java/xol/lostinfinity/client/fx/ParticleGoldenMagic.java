...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGoldenMagic.class */
public class ParticleGoldenMagic extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleGoldenMagic(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.growSpeed = 0.4f;
        func_187117_a(ParticleInit.GOLDEN_MAGIC_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGoldenMagic$Factory.class */
