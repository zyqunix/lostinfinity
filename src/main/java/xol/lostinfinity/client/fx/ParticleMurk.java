...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleMurk.class */
public class ParticleMurk extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleMurk(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.MURK_SPRITE);
    }
    ...
    public void func_189213_a() {
        ...
        if (i >= this.field_70547_e) {
            if (this.scale > 0.0d) {
                ...
                this.field_82339_as = (float) (((double) this.field_82339_as) - 0.1d);
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleMurk$Factory.class */
