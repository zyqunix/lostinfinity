...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleElectricExplosionBlue.class */
public class ParticleElectricExplosionBlue extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleElectricExplosionBlue(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.ELECTRIC_EXPLOSION_BLUE_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleElectricExplosionBlue$Factory.class */
