...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleNuclearBlast.class */
public class ParticleNuclearBlast extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleNuclearBlast(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.NUCLEAR_BLAST_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleNuclearBlast$Factory.class */
