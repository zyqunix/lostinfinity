...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleDarkFizzle.class */
public class ParticleDarkFizzle extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleDarkFizzle(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.DARK_FIZZLE_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleDarkFizzle$Factory.class */
