...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleExplosionTeal.class */
public class ParticleExplosionTeal extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleExplosionTeal(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.EXPLOSION_TEAL_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleExplosionTeal$Factory.class */
