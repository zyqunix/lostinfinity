...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleExplosionYellow.class */
public class ParticleExplosionYellow extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleExplosionYellow(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.EXPLOSION_YELLOW_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleExplosionYellow$Factory.class */
