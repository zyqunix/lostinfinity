...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleLaserFizzle.class */
public class ParticleLaserFizzle extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleLaserFizzle(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.LASER_FIZZLE_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleLaserFizzle$Factory.class */
