...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGalaxyGreen.class */
public class ParticleGalaxyGreen extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleGalaxyGreen(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.GALAXY_GREEN_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGalaxyGreen$Factory.class */
