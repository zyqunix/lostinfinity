...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGenericDotRed.class */
public class ParticleGenericDotRed extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleGenericDotRed(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.GENERIC_DOT_RED_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGenericDotRed$Factory.class */
