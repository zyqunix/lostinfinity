...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticlePrismaticExplosionType1.class */
public class ParticlePrismaticExplosionType1 extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticlePrismaticExplosionType1(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.PRISMATIC_EXPLOSION_TYPE1_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticlePrismaticExplosionType1$Factory.class */
