...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleSupersonicRed.class */
public class ParticleSupersonicRed extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleSupersonicRed(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.SUPERSONIC_RED_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleSupersonicRed$Factory.class */
