...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticlePrismaticExplosionType2.class */
public class ParticlePrismaticExplosionType2 extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticlePrismaticExplosionType2(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.PRISMATIC_EXPLOSION_TYPE2_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticlePrismaticExplosionType2$Factory.class */
