...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticlePowerLoss.class */
public class ParticlePowerLoss extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticlePowerLoss(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.POWER_LOSS_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticlePowerLoss$Factory.class */
