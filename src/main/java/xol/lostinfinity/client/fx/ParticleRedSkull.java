...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleRedSkull.class */
public class ParticleRedSkull extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleRedSkull(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.growSpeed = 0.2f;
        func_187117_a(ParticleInit.RED_SKULL_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleRedSkull$Factory.class */
