...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleLaserFizzleLarge.class */
public class ParticleLaserFizzleLarge extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleLaserFizzleLarge(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.field_187129_i = this.field_187136_p.nextDouble() - 0.5d;
        this.field_187131_k = this.field_187136_p.nextDouble() - 0.5d;
        this.scale = RANDOM.nextFloat();
        this.field_70547_e = (int) (14.0d / ((Math.random() * 0.8d) + 0.2d));
        func_187117_a(ParticleInit.LASER_FIZZLE_LARGE_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleLaserFizzleLarge$Factory.class */
