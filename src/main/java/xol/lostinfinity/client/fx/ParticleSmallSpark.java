...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleSmallSpark.class */
public class ParticleSmallSpark extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleSmallSpark(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.growSpeed = 0.2f;
        func_187117_a(ParticleInit.SMALL_SPARK_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleSmallSpark$Factory.class */
