...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleExplosionOrange.class */
public class ParticleExplosionOrange extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleExplosionOrange(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.EXPLOSION_ORANGE_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleExplosionOrange$Factory.class */
