...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleTeslaRingYellow.class */
public class ParticleTeslaRingYellow extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleTeslaRingYellow(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.TESLA_RING_YELLOW_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleTeslaRingYellow$Factory.class */
