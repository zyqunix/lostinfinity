...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGalaxyBlue.class */
public class ParticleGalaxyBlue extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleGalaxyBlue(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.GALAXY_BLUE_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGalaxyBlue$Factory.class */
