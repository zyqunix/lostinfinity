...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticlePrismaticExplosionType3.class */
public class ParticlePrismaticExplosionType3 extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticlePrismaticExplosionType3(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.PRISMATIC_EXPLOSION_TYPE3_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticlePrismaticExplosionType3$Factory.class */
