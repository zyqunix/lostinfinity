...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleDarkMagic.class */
public class ParticleDarkMagic extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleDarkMagic(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.growSpeed = 0.1f;
        func_187117_a(ParticleInit.DARK_MAGIC_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleDarkMagic$Factory.class */
