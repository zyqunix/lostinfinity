...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleVenomRing.class */
public class ParticleVenomRing extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleVenomRing(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeed, double ySpeed, double zSpeed) {
        ...
        func_187117_a(ParticleInit.VENOM_RING_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleVenomRing$Factory.class */
