...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGenericDotAqua.class */
public class ParticleGenericDotAqua extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleGenericDotAqua(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.GENERIC_DOT_AQUA_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGenericDotAqua$Factory.class */
