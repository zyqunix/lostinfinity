...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleDarkFlash.class */
public class ParticleDarkFlash extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleDarkFlash(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.growSpeed = 0.1f;
        func_187117_a(ParticleInit.DARK_FLASH_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleDarkFlash$Factory.class */
