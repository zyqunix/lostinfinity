...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleCosmicExplosionType1.class */
public class ParticleCosmicExplosionType1 extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleCosmicExplosionType1(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.COSMIC_EXPLOSION_TYPE1_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleCosmicExplosionType1$Factory.class */
