...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGlomiteWarp.class */
public class ParticleGlomiteWarp extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleGlomiteWarp(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.GLOMITE_WARP_SPRITE);
    }
    ...
    public void func_189213_a() {
        ...
        if (this.scale < 45.0f) {
            ...
            this.scale = (float) (((double) this.scale) + 0.05d);
        } else {
            this.prevScale = this.scale;
        }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGlomiteWarp$Factory.class */
