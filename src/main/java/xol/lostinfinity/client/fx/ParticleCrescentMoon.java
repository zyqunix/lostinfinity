...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleCrescentMoon.class */
public class ParticleCrescentMoon extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleCrescentMoon(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.CRESCENT_MOON_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleCrescentMoon$Factory.class */
