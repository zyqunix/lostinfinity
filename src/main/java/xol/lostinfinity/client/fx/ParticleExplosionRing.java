...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleExplosionRing.class */
public class ParticleExplosionRing extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleExplosionRing(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.EXPLOSION_RING_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleExplosionRing$Factory.class */
