...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleShadowBlast.class */
public class ParticleShadowBlast extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleShadowBlast(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.SHADOW_BLAST_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleShadowBlast$Factory.class */
