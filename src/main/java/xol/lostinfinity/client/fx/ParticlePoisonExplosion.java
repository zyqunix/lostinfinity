...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticlePoisonExplosion.class */
public class ParticlePoisonExplosion extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticlePoisonExplosion(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.POISON_EXPLOSION_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticlePoisonExplosion$Factory.class */
