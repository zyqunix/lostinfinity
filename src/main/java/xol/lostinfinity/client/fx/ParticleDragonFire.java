...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleDragonFire.class */
public class ParticleDragonFire extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleDragonFire(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.growSpeed = 0.4f;
        func_187117_a(ParticleInit.DRAGON_FIRE_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleDragonFire$Factory.class */
