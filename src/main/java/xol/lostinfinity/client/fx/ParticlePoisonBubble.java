...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticlePoisonBubble.class */
public class ParticlePoisonBubble extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticlePoisonBubble(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.growSpeed = 0.1f;
        func_187117_a(ParticleInit.POISON_BUBBLE_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticlePoisonBubble$Factory.class */
