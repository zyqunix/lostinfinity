...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleCosmicExplosionType4.class */
public class ParticleCosmicExplosionType4 extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleCosmicExplosionType4(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.COSMIC_EXPLOSION_TYPE4_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleCosmicExplosionType4$Factory.class */
