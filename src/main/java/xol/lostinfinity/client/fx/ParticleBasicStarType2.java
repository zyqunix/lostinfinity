...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleBasicStarType2.class */
public class ParticleBasicStarType2 extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleBasicStarType2(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.field_70547_e = ((int) (5.0d / ((((double) this.field_187136_p.nextFloat()) * 0.8d) + 0.2d))) + 8;
        this.growSpeed = 0.4f;
        func_187117_a(ParticleInit.BASIC_STAR_TYPE2_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleBasicStarType2$Factory.class */
