...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleFlameMedium.class */
public class ParticleFlameMedium extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleFlameMedium(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.field_187129_i = (-0.15d) + (this.field_187136_p.nextDouble() * 0.3d);
        this.field_187131_k = (-0.15d) + (this.field_187136_p.nextDouble() * 0.3d);
        ...
        func_187117_a(ParticleInit.FLAME_MEDIUM_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleFlameMedium$Factory.class */
