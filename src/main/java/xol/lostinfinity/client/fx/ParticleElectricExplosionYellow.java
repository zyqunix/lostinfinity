...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleElectricExplosionYellow.class */
public class ParticleElectricExplosionYellow extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleElectricExplosionYellow(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.ELECTRIC_EXPLOSION_YELLOW_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleElectricExplosionYellow$Factory.class */
