...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleTeslaRingBlue.class */
public class ParticleTeslaRingBlue extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleTeslaRingBlue(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.TESLA_RING_BLUE_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleTeslaRingBlue$Factory.class */
