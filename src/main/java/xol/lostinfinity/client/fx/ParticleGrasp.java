...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGrasp.class */
public class ParticleGrasp extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleGrasp(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeed, double ySpeed, double zSpeed) {
        ...
        func_187117_a(ParticleInit.GRASP_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGrasp$Factory.class */
