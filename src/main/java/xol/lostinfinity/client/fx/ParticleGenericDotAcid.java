...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGenericDotAcid.class */
public class ParticleGenericDotAcid extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleGenericDotAcid(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.GENERIC_DOT_ACID_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGenericDotAcid$Factory.class */
