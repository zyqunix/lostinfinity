...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleLargeBubblePurple.class */
public class ParticleLargeBubblePurple extends LostParticle {
    private static final Random RANDOM = new Random();
    private float maxScale;

    protected ParticleLargeBubblePurple(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.LARGE_BUBBLE_PURPLE_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleLargeBubblePurple$Factory.class */
