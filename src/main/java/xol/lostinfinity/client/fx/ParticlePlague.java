...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticlePlague.class */
public class ParticlePlague extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticlePlague(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.growSpeed = 0.1f;
        func_187117_a(ParticleInit.PLAGUE_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticlePlague$Factory.class */
