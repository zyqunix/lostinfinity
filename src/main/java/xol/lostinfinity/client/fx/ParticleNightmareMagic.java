...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleNightmareMagic.class */
public class ParticleNightmareMagic extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleNightmareMagic(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.NIGHTMARE_MAGIC_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleNightmareMagic$Factory.class */
