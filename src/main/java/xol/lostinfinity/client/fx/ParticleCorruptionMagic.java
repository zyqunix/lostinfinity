...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleCorruptionMagic.class */
public class ParticleCorruptionMagic extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleCorruptionMagic(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.growSpeed = 0.1f;
        func_187117_a(ParticleInit.CORRUPTION_MAGIC_SPRITE);
    }
    ...
    public void func_189213_a() {
        ...
        this.field_187129_i *= 1.0499999523162842d;
        this.field_187131_k *= 1.0499999523162842d;
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleCorruptionMagic$Factory.class */
