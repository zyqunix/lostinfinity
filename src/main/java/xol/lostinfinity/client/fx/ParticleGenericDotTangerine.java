...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGenericDotTangerine.class */
public class ParticleGenericDotTangerine extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleGenericDotTangerine(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.GENERIC_DOT_TANGERINE_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGenericDotTangerine$Factory.class */
