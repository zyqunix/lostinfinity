...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleCosmicExplosionType2.class */
public class ParticleCosmicExplosionType2 extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleCosmicExplosionType2(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.COSMIC_EXPLOSION_TYPE2_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleCosmicExplosionType2$Factory.class */
