...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleFlameSmall.class */
public class ParticleFlameSmall extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleFlameSmall(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.growSpeed = 0.2f;
        func_187117_a(ParticleInit.FLAME_SMALL_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleFlameSmall$Factory.class */
