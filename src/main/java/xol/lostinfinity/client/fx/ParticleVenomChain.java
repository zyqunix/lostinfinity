...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleVenomChain.class */
public class ParticleVenomChain extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleVenomChain(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.scale = 0.8f;
        this.field_70547_e = (int) (5.0d / ((Math.random() * 0.8d) + 0.2d));
        func_187117_a(ParticleInit.VENOM_CHAIN_SPRITE);
    }
    ...
    public void func_189213_a() {
        ...
        if (this.field_70547_e - this.field_70546_d >= 8) {
            ...
            this.prevScale = this.scale;
            this.scale = (float) (((double) this.scale) - 0.1d);
        }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleVenomChain$Factory.class */
