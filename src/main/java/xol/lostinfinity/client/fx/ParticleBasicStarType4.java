...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleBasicStarType4.class */
public class ParticleBasicStarType4 extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleBasicStarType4(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.growSpeed = 0.4f;
        func_187117_a(ParticleInit.BASIC_STAR_TYPE4_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleBasicStarType4$Factory.class */
