...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGenericDotWhite.class */
public class ParticleGenericDotWhite extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleGenericDotWhite(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.GENERIC_DOT_WHITE_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGenericDotWhite$Factory.class */
