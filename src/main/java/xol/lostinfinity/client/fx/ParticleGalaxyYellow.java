...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGalaxyYellow.class */
public class ParticleGalaxyYellow extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleGalaxyYellow(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.GALAXY_YELLOW_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGalaxyYellow$Factory.class */
