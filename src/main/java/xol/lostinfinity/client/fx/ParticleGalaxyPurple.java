...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGalaxyPurple.class */
public class ParticleGalaxyPurple extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleGalaxyPurple(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.GALAXY_PURPLE_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleGalaxyPurple$Factory.class */
