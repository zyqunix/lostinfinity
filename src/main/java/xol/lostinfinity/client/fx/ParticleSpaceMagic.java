...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleSpaceMagic.class */
public class ParticleSpaceMagic extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleSpaceMagic(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.SPACE_MAGIC_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleSpaceMagic$Factory.class */
