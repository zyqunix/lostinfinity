...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleBlueSkull.class */
public class ParticleBlueSkull extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleBlueSkull(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        this.growSpeed = 0.2f;
        func_187117_a(ParticleInit.BLUE_SKULL_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleBlueSkull$Factory.class */
