...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleExplosionRingDark.class */
public class ParticleExplosionRingDark extends LostParticle {
    private static final Random RANDOM = new Random();

    protected ParticleExplosionRingDark(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeed, double zSpeedIn) {
        ...
        func_187117_a(ParticleInit.EXPLOSION_RING_DARK_SPRITE);
    }
    ...
    /* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/client/fx/ParticleExplosionRingDark$Factory.class */
