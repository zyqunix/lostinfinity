...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/projectile/entity/EntityElementiumWater.class */
public class EntityElementiumWater extends EntityBaseThrowable {
    public EntityElementiumWater(World par1World) {
        super(par1World);
    }

    public EntityElementiumWater(World par1World, EntityLivingBase par2EntityLiving) {
