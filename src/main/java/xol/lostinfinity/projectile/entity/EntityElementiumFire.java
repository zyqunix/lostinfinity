...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/projectile/entity/EntityElementiumFire.class */
public class EntityElementiumFire extends EntityBaseThrowable {
    public EntityElementiumFire(World par1World) {
        super(par1World);
    }

    public EntityElementiumFire(World par1World, EntityLivingBase par2EntityLiving) {
