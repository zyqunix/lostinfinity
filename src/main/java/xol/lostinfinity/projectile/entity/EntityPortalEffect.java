...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/projectile/entity/EntityPortalEffect.class */
public class EntityPortalEffect extends Entity {
    ...
    public EntityPortalEffect(World worldIn) {
        super(worldIn);
        this.growth = 0.0f;
        this.rotation = 0.0f;
        this.angle = 0.0f;
