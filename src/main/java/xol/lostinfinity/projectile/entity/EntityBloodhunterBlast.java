...
public class EntityBloodhunterBlast extends EntityBaseThrowable {
    ...
    protected void func_70184_a(RayTraceResult result) {
        if (!this.field_70170_p.field_72995_K) {
            if (result.field_72308_g != null && result.field_72308_g != func_85052_h() && (result.field_72308_g instanceof EntityPlayer) && this.field_70170_p.field_73011_w.func_186058_p() == DimensionInit.grandmasterOutpost) {
