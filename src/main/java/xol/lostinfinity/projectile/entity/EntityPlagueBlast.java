...
public class EntityPlagueBlast extends EntityBaseThrowable {
    ...
    protected void func_70184_a(RayTraceResult result) {
        if (!this.field_70170_p.field_72995_K) {
            if (result.field_72308_g != null && func_85052_h() != null && !result.field_72308_g.equals(func_85052_h()) && (result.field_72308_g instanceof EntityLivingBase) && IMaxAttack.dealMaxHealth(this, result.field_72308_g, 10).didSuccessfulHit()) {
                result.field_72308_g.func_70690_d(new PotionEffect(PotionInit.PLAGUE, 150, this.addPoison));
            }
            func_70106_y();
        }
    }
