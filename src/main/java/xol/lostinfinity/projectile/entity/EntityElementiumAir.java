...
public class EntityElementiumAir extends EntityBaseThrowable {
    public EntityElementiumAir(World par1World) {
        super(par1World);
    }
    public EntityElementiumAir(World par1World, EntityLivingBase par2EntityLiving) {
