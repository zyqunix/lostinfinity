...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/projectile/entity/EntityClusterBlast.class */
public class EntityClusterBlast extends EntityBaseThrowable {
    public EntityClusterBlast(World par1World) {
        super(par1World);
    }

    public EntityClusterBlast(World par1World, EntityLivingBase par2EntityLiving) {
        super(par1World, par2EntityLiving);
    }

    public EntityClusterBlast(World par1World, double par2, double par4, double par6) {
