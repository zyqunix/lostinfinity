...
public class EntityMicroRocket extends EntityBaseThrowable {
    ...
    protected void func_70184_a(RayTraceResult result) {
        if (!this.field_70170_p.field_72995_K) {
            if (func_85052_h() != null) {
                for (EntityLivingBase target : this.field_70170_p.func_72872_a(EntityLivingBase.class, func_174813_aQ().func_186662_g(3.0d))) {
                    if (!target.func_110124_au().equals(func_85052_h().func_110124_au())) {
                        IMaxAttack.dealTrueDamage(this, target, target.func_110138_aP() / 3.0f);
                    }
                }
            }
            ...
            this.field_70170_p.func_184133_a((EntityPlayer) null, func_180425_c(), SoundInit.MISSILE_EXPLOSION, SoundCategory.PLAYERS, 1.5f, 0.6f + (0.4f * this.field_70146_Z.nextFloat()));
            func_70106_y();
        }
    }
                ...
                if (this.target == null || this.target.field_70128_L) {
                    ...
                    for (EntityLivingBase entity : this.field_70170_p.func_72872_a(EntityLivingBase.class, new AxisAlignedBB(func_180425_c().func_177982_a(-20, -20, -20), func_180425_c().func_177982_a(HOMING_RADIUS, HOMING_RADIUS, HOMING_RADIUS)))) {
                        if (func_85052_h() == null || !func_85052_h().func_110124_au().equals(entity.func_110124_au())) {
                            ...
                            if (entity.field_70163_u >= this.targetingHeight && dist < minDist) {
                                minDist = dist;
                                closest = entity;
                            }
                        }
