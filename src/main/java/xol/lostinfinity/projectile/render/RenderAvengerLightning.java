...
public class RenderAvengerLightning<T extends Entity> extends Render<T> {
    ...
    public void func_76986_a(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        int remainder = ((Entity) entity).field_70173_aa % 7;
        if (remainder == 0) {
        ...
        if (target != null && target2 != null) {
            Vec3d targetVec = new Vec3d(target.field_72450_a, target.field_72448_b + (attackEntity.getOriginHeight() / 2.0d), target.field_72449_c);
            Vec3d target2Vec = new Vec3d(target2.field_72450_a, target2.field_72448_b + (attackEntity.getTargetHeight() / 2.0d), target2.field_72449_c);
            ...
            if (((Entity) entity).field_70173_aa % 10 < 5) {
                alpha = 0.3f + ((((Entity) entity).field_70173_aa % 10) * 0.14f);
            } else {
                alpha = 1.0f - (((((Entity) entity).field_70173_aa % 10) - 5) * 0.14f);
            }
