...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/projectile/render/RenderTormentorChain.class */
public class RenderTormentorChain<T extends Entity> extends Render<T> {
