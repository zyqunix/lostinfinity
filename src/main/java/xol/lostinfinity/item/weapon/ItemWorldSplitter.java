...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/item/weapon/ItemWorldSplitter.class */
public class ItemWorldSplitter extends ItemCooldown implements ICustomRaytrace {
    ...
    public void func_77624_a(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add(TextFmt.Gold + "Summons a World Splitter where you aim.");
        tooltip.add(TextFmt.Green + "World Splitters apply Phased, Intangible & Ultraheavy");
    }
}
