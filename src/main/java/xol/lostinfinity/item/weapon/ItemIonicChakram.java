...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/item/weapon/ItemIonicChakram.class */
public class ItemIonicChakram extends Item implements ISwitchModels {
    ...
    public ActionResult<ItemStack> func_77659_a(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (mode == 0) {
            if (!worldIn.field_72995_K) {
                EntityIonicChakram shot = new EntityIonicChakram(worldIn, playerIn);
    ...
    public void func_77624_a(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add(TextFmt.Yellow + "Throws a Chakram that splits into several upon collision.");
        tooltip.add(TextFmt.Red + "Deals 33% Health True Damage");
        tooltip.add(TextFmt.Gold + "Deals 75% Health True Damage Once Split");
        tooltip.add(TextFmt.Italic + "Split rings remove 5 lives from multi-life creatures");
