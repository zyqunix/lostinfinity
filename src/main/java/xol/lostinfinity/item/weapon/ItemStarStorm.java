...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/item/weapon/ItemStarStorm.class */
public class ItemStarStorm extends ItemCooldown {
    ...
    public void func_77624_a(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add(TextFmt.Yellow + "Fires a projectile that creates a bunch of falling stars.");
        tooltip.add(TextFmt.Red + "Stars deal 33% max health each.");
    }
}
