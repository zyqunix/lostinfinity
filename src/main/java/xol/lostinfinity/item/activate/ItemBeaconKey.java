    ...
    public ActionResult<ItemStack> func_77659_a(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        if (worldIn.field_73011_w.func_186058_p() == DimensionInit.cartographerRealmBot && playerIn.field_70165_t > -16.0d && playerIn.field_70165_t < 16.0d && playerIn.field_70161_v > -16.0d && playerIn.field_70161_v < 16.0d && playerIn.field_70163_u > 29.0d) {
            if (!worldIn.field_72995_K) {
                ...
                master.func_70624_b(playerIn);
                worldIn.func_72838_d(master);
                CustomParticleConfig config1 = new CustomParticleConfig();
                config1.createInstance().setParticle(ParticleInit.DARK_FLASH).setSpread(1.0d, 1.0d, 1.0d).setCount(5).setIgnoreRange(true);
                ...
                worldIn.func_184133_a((EntityPlayer) null, playerIn.func_180425_c(), SoundInit.NEBULOUS_BEACON, SoundCategory.PLAYERS, 1.0f, 1.0f);
            }
