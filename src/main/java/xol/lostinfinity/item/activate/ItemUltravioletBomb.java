...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/item/activate/ItemUltravioletBomb.class */
public class ItemUltravioletBomb extends Item {
    ...
    public ActionResult<ItemStack> func_77659_a(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        if (!worldIn.field_72995_K) {
            for (EntityLeer creature : worldIn.func_72872_a(EntityLeer.class, playerIn.func_174813_aQ().func_72314_b(10.0d, 10.0d, 10.0d))) {
    ...
    public void func_77624_a(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add(TextFmt.Gold + "Reveals things that may be hidden.");
    }
}
