    ...
    public ActionResult<ItemStack> func_77659_a(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        if (!worldIn.field_72995_K) {
            ...
            while (true) {
                ...
                if (worldIn.func_180495_p(pos).func_177230_c() == BlockInit.leavesLumio) {
                    foundLeaves = true;
                    break;
                }
            }
            if (foundLeaves) {
                ...
                for (EntityWisp creature : worldIn.func_72872_a(EntityWisp.class, playerIn.func_174813_aQ().func_72314_b(10.0d, 10.0d, 10.0d))) {
                    if (!creature.field_70128_L) {
                        EntityItem heart = new EntityItem(worldIn, creature.field_70165_t, creature.field_70163_u, creature.field_70161_v, new ItemStack(ItemInit.heartOfLight));
                ...
                if (didWisp) {
                    playerIn.func_145747_a(new TextComponentString(TextFmt.Aqua + "The light grows stronger..."));
                }
            }
