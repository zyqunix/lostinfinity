...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/item/misc/ItemBallOfContainedGluons.class */
public class ItemBallOfContainedGluons extends Item {
    ...
    public ActionResult<ItemStack> func_77659_a(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (!worldIn.field_72995_K) {
            EntityBallOfContainedGluons shot = new EntityBallOfContainedGluons(worldIn, playerIn);
