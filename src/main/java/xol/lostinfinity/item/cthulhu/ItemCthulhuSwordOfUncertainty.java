...
/* JADX INFO: loaded from: lostinfinity-1.16.4.jar:xol/lostinfinity/item/cthulhu/ItemCthulhuSwordOfUncertainty.class */
public class ItemCthulhuSwordOfUncertainty extends AbstractCthulhuSword {
    ...
    private static void checkHittingBarrier(EntityPlayer entityPlayer) {
        ...
        if (entityPlayer.func_184586_b(EnumHand.MAIN_HAND).func_77973_b().equals(ItemInit.cthulhuSwordUncertainty) && world.field_72995_K && isHittingBarrier(entityPlayer)) {
            ...
            entityPlayer.field_70170_p.field_72996_f.stream().filter(entity -> {
                ...
                sendCthulhuPacket(4, 20, cthulhu.func_145782_y());
            });
        }
    }
}
